...
require_current_action(_PROJECT_ROOT, task_id='PHASE380_PROSPECTIVE_TARGET_READER_AI_SMELL_DISCRIMINATOR_CALIBRATION_V1', phase_ordinal=380,
                       action_id='tools/phase380_mark_ready.py', parameters={})
