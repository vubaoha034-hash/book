...
require_current_action(_PROJECT_ROOT, task_id='PHASE379_TARGET_READER_AI_SMELL_DISCRIMINATOR_RECALIBRATION_V1', phase_ordinal=379,
                       action_id='tools/phase379_to_380.py', parameters={})
